    ...
    ZG: {
      ...
      sizes: [
        ...
        },
        {
          label: 'ZG9',
          volumes: [
            12000, 10920, 9960, 9240, 8640, 8160, 7860, 7560, 7380, 7200, 7032, 6840,
            6720, 6600, 6480, 6360, 6240, 6120, 6000, 5880, 5820, 5160, 4680, 4260, 3840,
            3480, 3120, 2820, 2520, 2280, 2040, 1800, 1584, 1380, 1200,
          ],
        },
        {
          label: 'ZG10',
          volumes: [
            24000, 21840, 19920, 18480, 17280, 16320, 15720, 15120, 14760, 14400, 14064,
            13680, 13440, 13200, 12960, 12720, 12480, 12240, 12000, 11760, 11640, 10320,
            9360, 8520, 7680, 6960, 6240, 5640, 5040, 4560, 4080, 3600, 3168, 2760, 2400,
          ],
        },
      ],
      viscosities: [
